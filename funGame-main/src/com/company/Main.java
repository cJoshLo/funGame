...
public class Main {
    ...
    private static String checkAction(Room currentRoom, String action, Character soldier, boolean doorLock) {
        ...
        if (action.equals("left") || action.equals("right") || action.equals("back")) { //----------Movement
            if (currentRoom.left != null && action.equals("left")) {
                ...
                if(currentRoom.getInteractive().equals("keyhole Room") && doorLock == true){
            ...
            Item weapon = soldier.getItems(item);
            if(weapon != null){
                System.out.println("The stats of " + weapon.getName() + " is attack:"
                        + weapon.getAdditionalAttack() + "+, defense: " + weapon.getAdditionalDefense() + "+.");
            }else{
                System.out.println("You do no have that item");
            }
    ...
    public static void main(String[] args) {
        ...
        Item trophie = new Item(0,0,"Trophie");
        ...
        Room beatTheGameRoom = new Room(null, trophie, "won Room");
...
//            System.out.println(current.getItem());
            ...
            String checked = checkAction(current, action, character, doorLock);// ----------------------User input check
